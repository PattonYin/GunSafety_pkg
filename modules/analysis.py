...
df_edge_list = pd.read_csv("data/raw/edge_list.csv")
...
def compute_patent_citation_span(path_to_data="data", edge_list=df_edge_list):
    check_path(path_to_data)
    edge_list = compute_edge_list(edge_list)
    date_span(path_to_data=path_to_data, edge_list=edge_list)    
...
def average_span(path_to_data="data"):
    ...
    data_path = os.path.join(data_path, 'processed/citation_span.csv')
    output_path = os.path.join(output_path, 'processed/avg_citation_span.csv')
...
def plot_distribution(path_to_data="data", save=False):
    ...
    check_path(path_to_data)
    # configure path variables
    data_path = os.path.join(data_path, 'processed/avg_citation_span.csv')
    output_path = os.path.join(output_path, 'processed/avg_span_distribution.png')
...
def plot_distribution_2(path_to_data="data", save=False, bins=50, kde=True, color='teal'):
    ...
    # configure path variables
    data_path = os.path.join(data_path, 'processed/citation_span.csv')
    output_path = os.path.join(output_path, 'processed/avg_span_distribution_2.png')
